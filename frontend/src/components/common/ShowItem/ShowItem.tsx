	...
	return (
		<div className='show-item'>
			<div className='show-item-info'>
				<img className="img-content" src={`${URL_IMAGE}/D_NQ_NP_${item.picture_id}-F.jpg`} alt={`Item ${item.title}`} />
			...
			<div className='show-item-content'>
					...
					<div className='mount'>{currency(item.price.amount,item.price.currency,0)}</div>
